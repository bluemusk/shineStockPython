...
def custom_func(col, aggr_df):
    ...
    return cnt_1_b, cnt_1_d, cnt_2_b, cnt_2_d, cnt_3_b, cnt_3_d, cnt_4_b, cnt_4_d, cnt_5_b, cnt_5_d \
        ...
        , num_0, num_1, num_2, num_3, step1, step2, step3, step4rh
...
def conditionMake(data, aggr_df, mode, leafType, lvl, condition, prevBcnt, prevDcnt, ratDf, exceptCon):
    ...
    try:
        ...
        if leafType == 'A':
            # 이전 레벨 bcnt의 20% 이상이면서 bvsd가 가장 좋은 것
            tmpFinal = tmpFinal[(tmpFinal['bcnt'] >= prevBcnt * 0.9)].sort_values('bvsd', ascending=False).iloc[0:]
        elif leafType == 'B':
            tmpFinal = tmpFinal[(tmpFinal['bcnt'] >= prevBcnt * 0.8)].sort_values('bvsd', ascending=False).iloc[0:]
        elif leafType == 'C':
            tmpFinal = tmpFinal[(tmpFinal['bcnt'] >= prevBcnt * 0.7)].sort_values('bvsd', ascending=False).iloc[0:]
        elif leafType == 'D':
            tmpFinal = tmpFinal[(tmpFinal['bcnt'] >= prevBcnt * 0.6)].sort_values('bvsd', ascending=False).iloc[0:]
        elif leafType == 'E':
            tmpFinal = tmpFinal[(tmpFinal['bcnt'] >= prevBcnt * 0.5)].sort_values('bvsd', ascending=False).iloc[0:]
        else:
            tmpFinal = pd.DataFrame()
...
additionalCond = "((df['R_LH7'] > -0.9) & (df['R_RSICCI18'] > -89.3) & (df['R_MACDMACSSIG13'] > -48.6) & (df['R_CCIRSI1'] > 3.0) & (df['R_HIH13'] > 0.5))       " \
" | ((df['R_LH7'] > -0.9) & (df['R_OPN7'] > 0.2) & (df['R_MACD7'] > -69.5) & (df['R_HIH6'] > 0.4) & (df['R_HIH4'] > 0.5))                      " \
" | ((df['R_LH7'] > -0.9) & (df['R_HIH13'] > 0.0) & (df['R_MACDMACSSIG7'] > -70.2) & (df['R_HIH6'] > 0.3) & (df['R_HIH4'] > 0.4))              " \
" | ((df['R_DIS10DIS601'] <= 0.5) & (df['R_LH7'] > -0.5) & (df['R_MACDMACSSIG7'] > -69.0) & (df['R_HIH7'] > 0.5) & (df['R_HIH6'] > 0.7))       " \
" | ((df['R_DIS10DIS601'] <= 0.5) & (df['R_LH7'] > -0.5) & (df['R_MACDMACSSIG7'] > -69.0) & (df['R_HIH7'] > 0.5) & (df['R_CCI13'] > -74.1))    " \
" | ((df['R_DIS10DIS601'] <= 0.5) & (df['R_LH7'] > -0.5) & (df['R_MACDMACSSIG7'] > -69.0) & (df['R_CCIRSI12'] > -39.7) & (df['R_HIH7'] > 0.5)) "

name = 'SELLMART_ALL_NEW_510_1_all'
fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'all')
#
# name = 'SELLMART_ALL_NEW_510_1_fsjtabuy'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fsjtabuy')
#
# name = 'SELLMART_ALL_NEW_510_1_fncbuy3'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fncbuy3')
#
# name = 'SELLMART_ALL_NEW_510_1_finobuy1'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy1')
#
# name = 'SELLMART_ALL_NEW_510_1_finobuy2'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy2')
#
# name = 'SELLMART_ALL_NEW_510_1_finobuyt8'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuyt8')
# ##########################################################################################
#
...
name = 'SELLMART_ALL_NEW_1015_1_all'
fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'all')
#
# name = 'SELLMART_ALL_NEW_1015_1_fsjtabuy'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fsjtabuy')
#
# name = 'SELLMART_ALL_NEW_1015_1_fncbuy3'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fncbuy3')
#
# name = 'SELLMART_ALL_NEW_1015_1_finobuy1'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy1')
#
# name = 'SELLMART_ALL_NEW_1015_1_finobuy2'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy2')
#
# name = 'SELLMART_ALL_NEW_1015_1_finobuyt8'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuyt8')
# ##########################################################################################
# # Data Loading
...
name = 'SELLMART_ALL_NEW_15AB_1_all'
fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'all')
#
# name = 'SELLMART_ALL_NEW_15AB_1_fsjtabuy'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fsjtabuy')
#
# name = 'SELLMART_ALL_NEW_15AB_1_fncbuy3'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'fncbuy3')
#
# name = 'SELLMART_ALL_NEW_15AB_1_finobuy1'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy1')
#
# name = 'SELLMART_ALL_NEW_15AB_1_finobuy2'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuy2')
#
# name = 'SELLMART_ALL_NEW_15AB_1_finobuyt8'
# # function Exec
# fResult = drawCondiInitTree(path, 4, 0.2, additionalCond, name, 'finobuyt8')