...
# Data Loading
df = pd.read_csv('C:/Users/Shine_anal/PycharmProjects/anlaysis/inobuy4_close_h4_9year.csv')  # dtree돌릴 원본 데이터
dfCon = pd.read_csv('C:/Users/Shine_anal/PycharmProjects/anlaysis/test.csv', header=None)    # str1,2,3 조건 조합으로 만들어 낸 csv파일 
